...
<p style="text-align: justify">A seguir são apresentadas algumas imagens do projeto.</p>

```{r echo=FALSE}
library(slickR)
library(htmltools)

# Caminhos das imagens e iframe do YouTube

imagens <- c("img/img101.jpg", "img/img102.jpg", "img/img103.jpg")
video <- list(div(
    tags$iframe(src = "https://www.youtube.com/embed/I9YF8PIzGb8", 
...
midias <- c(imagens, video)

# Criação do carrossel com `slickR`
carrossel <- slickR(obj = midias, width = "80%", height = 400)
